		...
		<form action="criminal" method="post" enctype="multipart/form-data">
			<div class="login-box">
				<div class="user-box">
					...
					<div>
						<b> conform password :<input type="number" name="adminid"
							placeholder="Enter conform password""></b>
					</div>
					<br>
					<div>
						<b> New password : <input type="text" name="password"
							placeholder="Enter New password" value="${entity.password}"></b>
					</div>
<br>
					<div>
						<b>Conform New password : <input type="text" name="password"
							placeholder="Enter New password" value="${entity.password}"></b>
					</div>
