					...
					<div class="user-box">
						...
						<div>
							<b> BPL Card : <input type="radio" id="Yes" name="bplCard"
								value="Yes" ${entity.bplCard} /> <label for="Yes">Yes</label> <input
								type="radio" id="No" name="bplCard" value="No" ${entity.bplCard} />
								<label for="No">No</label></b>
						</div>
						<div>

							<b> Insurance : <input type="radio" id="Yes" name="insurence"
								value="Yes" ${entity.insurence} /> <label for="Yes">Yes</label>
								<input type="radio" id="No" name="insurence" value="No"
								${entity.insurence} /> <label for="No">No</label> <br> <br>
							</b>
						</div>
						<div>
						...
						<!-- 	   <a href="SaveSuccuess.jsp" style="font-style: italic; font-weight: bolder; 
							background: green; border: bold; opacity: inherit;" >Save</a> -->
